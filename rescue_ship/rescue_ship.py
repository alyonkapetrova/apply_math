...
ships_places = input("Enter the ship's coordinates (ex.: 0,4; 6,12; 10,14): ")
coordinates_list = [tuple(map(float, i.split(','))) for i in ships_places.split('; ')]


def rescue_ship(coords):
